...
// PeSTO Tables (RofChade / Ethereal / Stockfish origins)
// Values are generally [Midgame, Endgame]

// Material Values (PeSTO-compatible)
// [PieceType][MG/EG]
inline int Material[PIECE_TYPE_NB][2] = {{0, 0},      // None
                                         {82, 94},    // Pawn
                                         {337, 281},  // Knight
                                         {365, 297},  // Bishop
                                         {477, 512},  // Rook
...
// Phase Weights (to calculate game phase)
inline int PhaseWeights[PIECE_TYPE_NB] = {0, 0, 1, 1, 2, 4, 0, 0};
constexpr int TotalPhaseMax = 24;
...
inline int eg_bishop_table[64] = {
    ...
    -6,  3,   13,  19, 7,  10, -3,  -9,  -12, -3, 5,   10,  10, -3,  -12, -24,
...
inline int mg_queen_table[64] = {
    ...
    -16, -16, -1, 17,  -2,  1,   -9, -26, -28, -10, 10,  3,   -11,
    -22, -14, 2,  -11, -2,  -5,  2,  14,  5,   -35, -8,  11,  2,
...
inline int mg_king_table[64] = {
    -65, 23,  16,  -15, -56, -34, 2,   13,  29,  -1,  -20, -30, -50,
    -10, -38, -29, -9,  24,  2,   -16, -20, 6,   22,  -22, -17, -20,
